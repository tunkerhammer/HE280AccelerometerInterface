...
#include <Wire.h>
#include <Adafruit_NeoPixel.h> // Comment out this line if NeoPixel are not used for lights 

#define DEBUG 1 // Comment out this line to not echo results to serial

//------------------------------------------------------------------------------------------------------
#define BRIGHTNESS 30 // Comment out this line if NeoPixel are not used for lights  
#define PIN 6 // Comment out this line if NeoPixel are not used for lights 
#define NUM_LEDS 92 // Comment out this line if NeoPixel are not used for lights  
Adafruit_NeoPixel strip = Adafruit_NeoPixel(NUM_LEDS, PIN, NEO_GRBW + NEO_KHZ800); // Comment out this line if NeoPixel are not used for lights 
//------------------------------------------------------------------------------------------------------



//------------------------------------------------------------------------------------------------------
// this is setup for Adafruit Feather 32u4 Basic Proto or Adafruit Feather M0 Basic Proto
...
void setup() {
  ...
  //------------------------------------------------------------------------------------------------------
  strip.setBrightness(BRIGHTNESS); // Comment out this line if NeoPixel are not used for lights 
  strip.begin(); // Comment out this line if NeoPixel are not used for lights 
  strip.show(); // Initialize all pixels to 'off'-- Comment out this line if NeoPixel are not used for lights 
  colorWipe(strip.Color(255, 0, 0), 50); // Red -- Comment out this line if NeoPixel are not used for lights 
  colorWipe(strip.Color(0, 255, 0), 50); // Green -- Comment out this line if NeoPixel are not used for lights 
  colorWipe(strip.Color(0, 0, 255), 50); // Blue -- Comment out this line if NeoPixel are not used for lights 
  colorWipe(strip.Color(0, 0, 0, 255), 80); // White-- Comment out this line to not use neopixs for lights
  //------------------------------------------------------------------------------------------------------ 
}
...
void colorWipe(uint32_t c, uint8_t wait) {
  for(uint16_t i=24; i<strip.numPixels(); i++) {
